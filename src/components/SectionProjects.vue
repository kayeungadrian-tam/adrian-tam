  ...
  <section id="projects" class="section" style="background: var(--color-bg)">
    <div class="section__container">
      <div class="section__header">
        ...
        <h2 class="section__title">Selected Builds & Open Source</h2>
      </div>
      ...
      <div class="section__content">
        ...
        >
          <div class="featured-card__left">
            ...
            <span v-else class="featured-private">
              Private prototype · architecture overview
            </span>
          </div>
        ...
        <div class="projects-grid">
          ...
          >
            ...
            <div class="project-card__body">
              ...
              <span v-else class="project-card__private">
                Private prototype · architecture overview
              </span>
            </div>
          </div>
...
const { onMove: onMagMove, onLeave: onMagLeave } = useMagnetic(0.25)
...
/* Animated mesh on hover */
.featured-card:hover .mesh-lines line {
  stroke: var(--color-accent);
  animation: dash-flow 1s linear infinite;
}

.featured-card:hover .mesh-node {
