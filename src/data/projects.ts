...
const projects = [
    {
        ...
        description: "A bible search engine powered by sentence transformers.",
    ...
    },
    {
        ...
        description: "A python package consists of useful decorators.",
    ...
    },
    {
        ...
        description: "A personal portfolio website made from scratch in Vue3 with TypeScript.",
...

    {
        ...
        description: "A GUI for image processing using OpenCV, PySimpleGUI and Yolov3.",
        link: "https://github.com/kayeungadrian-tam/Image_Processing",
        img: img1,
        tags: ["Python", "OpenCV", "PysimpleGUI", "Yolov3"],
        icons: [
    ...
    },
    {
        ...
        description: "A virtual webcam loop using OpenCV, Mediapipe and OBS.",
    ...
    },
    {
        ...
        description: "A 3D simulation of dynamic bicycle model with PID control.",
    ...
    },
    {
        ...
        description: "Reinforcement learning applied to autonomous driving with obstacle avoidance.",
    ...
    },
    {
        ...
        description: "A general purpose mobile application with real-time chatroom and user profiles.",
